...
import com.sutek.example.Transformations.UserTransformations
import com.sutek.example.services.{Database, FileIO, SparkBuilder}
import com.sutek.example.services.Database.{Credentials, Database}
import com.sutek.example.services.FileIO.FileIO
...
package Source {
  ...
  import com.sutek.example.items.{Post, User}
  import com.sutek.example.services.Database
  import com.sutek.example.services.Database.Database
...
package Transformations {
  ...
  import com.sutek.example.Source.DatabaseSource
  import com.sutek.example.items.User
  import com.sutek.example.services.Database.Database
